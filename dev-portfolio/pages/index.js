  ...
  return (
    <Layout title={"Portfolyo"} description={"my portfolyo"}>
      ...
      <motion.img
        ...
        alt='ball 2'
        className='hidden md:block h-auto absolute bottom-10 z-[1]'
        whileHover={{ y: -10, rotate: 90, transition: { duration: 0.4 } }}
        drag
        dragConstraints={{ top: 0, left: 0, right: 0, bottom: 0 }}
      />
        ...
        <section className='h-full max-w-5xl pt-16 mx-auto md:pt-8'>
          <div className='flex flex-col items-center justify-center md:items-start'>
            ...
            <div className='flex items-center mt-8 space-x-6 md:mt-4'>
              <motion.a
                href='https://github.com/egemenozyurek'
                target={"_blank"}
              ...
              <motion.a
                href="https://twitter.com/dobradeveloper"
                target={"_blank"}
                rel="noopener noreferrer"
                className="flex items-center justify-center text-gray-800 transition-colors duration-300 dark:text-gray-100 dark:hover:text-pinkish-200 hover:text-pinkish-200"
                whileHover={{ scale: 1.1 }}
              ...
              <motion.a
                href="https://www.linkedin.com/in/egemenozyurek/"
                target={"_blank"}
                rel="noopener noreferrer"
                className="flex items-center justify-center text-gray-800 transition-colors duration-300 dark:text-gray-100 dark:hover:text-pinkish-200 hover:text-pinkish-200"
                whileHover={{ scale: 1.1 }}
              ...
              <pre>
                <code className="language-js">
                  ...
                  <div className="flex items-center space-x-4">
                    <img
                      src="https://pbs.twimg.com/profile_images/1430675965710061569/yRWIBEkc_400x400.jpg"
                      alt="Me"
